...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'PremierePulse',
        short_name: 'PremierePulse',
        description: 'Daily Entertainment Release Tracker',
        theme_color: '#0f172a',
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          {
            urlPattern: /^https:\/\/tse2\.mm\.bing\.net\/.*/i,
            handler: 'CacheFirst',
            options: {
              cacheName: 'bing-proxy-cache',
              expiration: {
                maxEntries: 50,
                maxAgeSeconds: 60 * 60 * 24 * 7 // 7 days
              },
